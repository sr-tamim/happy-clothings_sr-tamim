...
import useCartContext from '../../others/useCartContext';
import './Navbar.css'
...
const Navbar = () => {
    ...
    return (
        <nav>
            <input type="checkbox" id='nav-links-toggler' />
            <label className='nav-links-toggler-icon' htmlFor="nav-links-toggler">
            ...
            <div className="nav-actions">
                ...
                <div className="nav-cart-icon">
                    ...
                    {cart.length > 0 &&
                        <div className="nav-cart-items-indicator">{cart.length}</div>
                    }
                </div>
            </div>
        </nav>
